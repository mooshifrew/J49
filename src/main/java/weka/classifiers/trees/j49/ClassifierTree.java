...
public class ClassifierTree implements Drawable, Serializable, RevisionHandler, CapabilitiesHandler {
   ...
   * Constructor.
   */
  public ClassifierTree(ModelSelection toSelectLocModel, DistributionFactory distributionFactory) {
  ...
  public void buildTree(Instances train, Instances test, boolean keepData)
    ...
    m_test = m_distributionFactory.getDistribution(test, m_localModel);
    if (m_localModel.numSubsets() > 1) {
  ...
  protected ClassifierTree getNewTree(Instances data) throws Exception {
    ...
    ClassifierTree newTree = new ClassifierTree(m_toSelectModel, m_distributionFactory);
