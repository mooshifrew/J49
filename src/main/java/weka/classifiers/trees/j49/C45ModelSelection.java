...
public class C45ModelSelection extends ModelSelection {
   ...
   * @param distributionFactory  this is the distribution factory that is used throughout the whole J49 model
   */
  public C45ModelSelection(int minNoObj, Instances allData,
    boolean useMDLcorrection, boolean doNotMakeSplitPointActualValue, DistributionFactory distributionFactory) {
    m_minNoObj = minNoObj;
    m_allData = allData;
    m_useMDLcorrection = useMDLcorrection;
    m_doNotMakeSplitPointActualValue = doNotMakeSplitPointActualValue;
    m_distributionFactory = distributionFactory;
  }
  ...
  public ClassifierSplitModel selectModel(Instances data) {
    ...
    try {
      ...
      checkDistribution = m_distributionFactory.getDistribution(data);
      noSplitModel = new NoSplit(checkDistribution, m_distributionFactory);
      ...
      for (i = 0; i < data.numAttributes(); i++) {
        ...
        if (i != (data).classIndex()) {
          ...
          currentModel[i] = new C45Split(i, m_minNoObj, sumOfWeights,
            m_useMDLcorrection, m_distributionFactory);
