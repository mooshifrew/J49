...
public class NBTreeClassifierTree extends ClassifierTree {
  ...
  public NBTreeClassifierTree(ModelSelection toSelectLocModel, DistributionFactory distributionFactory) {
  ...
  protected ClassifierTree getNewTree(Instances data) throws Exception {
    ...
    ClassifierTree newTree = new NBTreeClassifierTree(m_toSelectModel, m_distributionFactory);
