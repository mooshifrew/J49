...
public class NBTreeModelSelection extends ModelSelection {
   ...
   *          points).
   */
  public NBTreeModelSelection(int minNoObj, Instances allData, DistributionFactory distributionFactory) {
    m_minNoObj = minNoObj;
    m_allData = allData;
    ...
    try {
      ...
      for (i = 0; i < data.numAttributes(); i++) {
        ...
        if (i != (data).classIndex()) {
          ...
          currentModel[i] = new NBTreeSplit(i, m_minNoObj, sumOfWeights, m_distributionFactory);
