...
public class BinC45Split extends ClassifierSplitModel {
  ...
  public BinC45Split(int attIndex, int minNoObj, double sumOfWeights,
    boolean useMDLcorrection, DistributionFactory distributionFactory) {
  ...
  private void handleEnumeratedAttribute(Instances trainInstances)
    ...
    newDistribution = m_distributionFactory.getDistribution(numAttValues,
    ...
    for (i = 0; i < numAttValues; i++) {
      ...
      if (Utils.grOrEq(newDistribution.perBag(i), m_minNoObj)) {
        secondDistribution = m_distributionFactory.getDistribution(newDistribution, i);
  ...
  private void handleNumericAttribute(Instances trainInstances)
    ...
    m_distribution = m_distributionFactory.getDistribution(2, trainInstances.numClasses());
  ...
  public void resetDistribution(Instances data) throws Exception {
    ...
    Distribution newD = m_distributionFactory.getDistribution(insts, this);
