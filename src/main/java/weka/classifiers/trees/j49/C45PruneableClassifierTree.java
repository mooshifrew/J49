...
public class C45PruneableClassifierTree 
  ...
  public C45PruneableClassifierTree(ModelSelection toSelectLocModel,
				    ...
				    boolean raiseTree,
				    boolean cleanup,
                                    boolean collapseTree, DistributionFactory distributionFactory)
       throws Exception {

    super(toSelectLocModel, distributionFactory);
  ...
  public final void collapse(){
	...
	m_localModel = new NoSplit(localModel().distribution(), m_distributionFactory);
      }else
  ...
  protected ClassifierTree getNewTree(Instances data) throws Exception {
    ...
    C45PruneableClassifierTree newTree = 
      new C45PruneableClassifierTree(m_toSelectModel, m_pruneTheTree, m_CF,
				     m_subtreeRaising, m_cleanup, m_collapseTheTree, m_distributionFactory);
  ...
  protected double getEstimatedErrorsForBranch(Instances data)
    ...
    if (m_isLeaf)
      return getEstimatedErrorsForDistribution(m_distributionFactory.getDistribution(data));
    else{
