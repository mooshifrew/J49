...
public class NBTreeSplit extends ClassifierSplitModel {
   ...
   */
  public NBTreeSplit(int attIndex, int minNoObj, double sumOfWeights, DistributionFactory distributionFactory) {
  ...
  private void handleEnumeratedAttribute(Instances trainInstances)
    ...
    m_c45S = new C45Split(m_attIndex, 2, m_sumOfWeights, true, m_distributionFactory);
