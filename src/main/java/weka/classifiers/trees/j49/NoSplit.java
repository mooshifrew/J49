...
public final class NoSplit
   ...
   */
  public NoSplit(Distribution distribution, DistributionFactory distributionFactory){
    m_distributionFactory = distributionFactory;
    m_distribution = m_distributionFactory.getDistribution(distribution);
    m_numSubsets = 1;
  ...
  public final void buildClassifier(Instances instances) 
    ...
    m_distribution = m_distributionFactory.getDistribution(instances);
    m_numSubsets = 1;
  }
